...
def demthread(datasource, commonseed, dumpfolder, dpars):
    ...
    print(starttime)
    # remove the ground truths before demixing (took 500 frames in our experiments)
...
rootfolder = '/home/moro/localdata/03092019/'
datasetrange = [2]
...
rootfolder = '/home/moro/localdata/04092019/'
datasetrange = [2, 4]
...
rootfolder = '/home/moro/localdata/02102019/'
datasetrange = [3, 6]
datasources = datasources + [ rootfolder+ff for ff in os.listdir(rootfolder)\
                if (ff[-4:] == '.mat') and (len(ff) == 21) and 
                ff[-7:] in [f'{str(a).zfill(3)}.mat' for a in datasetrange]
...
parset = []
for initializ in ['nndsvd', 'random']:
    dpars = copy.copy(sdmx.demixing_pars)
    dpars['init'] = initializ
    parset.append(dpars)
